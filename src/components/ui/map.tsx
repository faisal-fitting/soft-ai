    ...
    >
      {closeButton && (
        <button
          type="button"
          onClick={handleClose}
          className="ring-offset-background focus:ring-ring absolute top-1 end-1 z-10 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-none"
...
function MarkerLabel({
  ...
  return (
    <div
      className={cn(
        "absolute start-1/2 -translate-x-1/2 rtl:translate-x-1/2 whitespace-nowrap",
